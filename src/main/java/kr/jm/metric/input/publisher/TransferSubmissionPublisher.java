...
public class TransferSubmissionPublisher<T> extends JMSubmissionPublisher<List<Transfer<T>>> implements
        TransferSubmissionPublisherInterface<T> {

    public TransferSubmissionPublisher(int publishers, int maxBufferCapacity, long waitingMillis) {
