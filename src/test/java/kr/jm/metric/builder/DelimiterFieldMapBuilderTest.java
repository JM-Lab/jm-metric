...
public class DelimiterFieldMapBuilderTest {
    ...
    public void testBuildFieldStringMap() {
        ...
        DelimiterMetricConfig inputConfig =
                new DelimiterMetricConfig("delimiterTest",
        ...
        inputConfig = new DelimiterMetricConfig("delimiterTest1");
        System.out.println(inputConfig.getFields());
        ...
        inputConfig = new DelimiterMetricConfig("delimiterTest2",
                " \\[|\\] \"|\" \"| \"|\" | ");
        System.out.println(inputConfig.getFields());
        ...
        inputConfig = new DelimiterMetricConfig("delimiterTest3",
                " ", "[\\\"\\[\\]]");
        System.out.println(inputConfig.getFields());
