...
## version
[![Maven Central](https://maven-badges.herokuapp.com/maven-central/kr.jmlab/jm-metric/badge.svg)](http://search.maven.org/#artifactdetails%7Ckr.jmlab%7Cjm-metric%7C0.2.6.1%7Cjar)
...
Gradle:
```groovy
compile 'kr.jmlab:jm-metric:0.2.6.1'
```
Maven:
```xml
<dependency>
...
cd jm-metric
git checkout -b 0.2.6.1 origin/0.2.6.1
