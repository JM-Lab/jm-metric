...
## version
[![Maven Central](https://maven-badges.herokuapp.com/maven-central/kr.jmlab/jm-metric/badge.svg)](http://search.maven.org/#artifactdetails%7Ckr.jmlab%7Cjm-metric%7C0.2.3%7Cjar)
...
Gradle:
```groovy
compile 'kr.jmlab:jm-metric:0.2.3'
```
Maven:
```xml
<dependency>
...
cd jm-metric
git checkout -b 0.2.3 origin/0.2.3
